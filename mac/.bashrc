...
#
# Secrets (API keys, OAuth tokens, 1Password service-account tokens, etc.)
# go in the SECRETS section. This file is not in git.
# =============================================================================

# Shared init: PATH, locale, mise, zoxide, fzf, prompt, completion.
